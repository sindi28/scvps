...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/sindi28/scvps/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/sindi28/scvps/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
wget raw.githubusercontent.com/sindi28/scvps/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
