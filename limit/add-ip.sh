...
data_ip="https://raw.githubusercontent.com/sindi28/scvps/main/izinIP"
checking_sc() {
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/sindi28/scvps/main/"
cd izin
export MYIP=$( curl -sS ipv4.icanhazip.com/ )
SELLER=$(curl -sS ${Repo1}ip | grep $MYIP | awk '{print $2}')
Exp100=$(curl -sS ${Repo1}ip | grep $MYIP | awk '{print $3}')
data_ip="https://raw.githubusercontent.com/sindi28/scvps/main/izin"
cd izin
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
   ...
   # read -p "  Input Username IP (Example : Lt) : " name
    ...
    git remote add origin https://github.com/sindi28/scvps
    git push -f https://${TOKEN}@github.com/sindi28/scvps.git &> /dev/null
    cd izinIp
    rm -rf /root/scvps
    clear
    sleep 1
